...
small_chunks = split_by_chunk(file_path, 4, 2)
...
small_chunks_csv_path = os.path.join(
    output_directory, f'{id_flag}_small_chunks.csv')
...
with open(small_chunks_csv_path, 'w') as f:
    f.write('Book,Chapter,VerseRange,Text\n')
